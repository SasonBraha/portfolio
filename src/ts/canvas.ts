  ...
  */
  ...
  function init() {
    const images = [
      ...
      { src: './assets/images/web-technologies/webstorm.svg', description: 'WebStorm', offset: 8 },
      ...
      { src: './assets/images/web-technologies/apollo.svg', description: 'Apollo GraphQL', offset: 25 }
    ];
